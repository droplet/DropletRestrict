DropletRestrict
===============
Restriction "Droplet" plugin for the Spout platform to demonstrate the usage of material restriction and permissions.
...
## Using the plugin
Simply place the latest [compiled jar][Builds] in Spout's plugins folder and change the `config.yml` located under `plugins/DropletRestrict`.
...
## The license
DropletRestrict and all "Droplet" plugins for the Spout platform are licensed under the [MIT License][License].
...
If you are using Git, use this command to clone the project:
    ...
    git clone git://github.com/Droplet/DropletRestrict.git

Or download the [latest zip archive][Source Download].

## Compiling the source
DropletRestrict uses Maven to handle its dependencies.
...
[Source]: https://github.com/Droplets/DropletRestrict
[Source Download]: https://github.com/Droplet/DropletRestrict/archive/master.zip
[Builds]: http://build.spout.org/job/DropletRestrict
